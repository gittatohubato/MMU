            ...
            if (i==0) {
                ...
                if(size==1){
                    if(this.totalMemorySize==this.segmentOrHoles.get(this.segmentOrHoles.size() - 1).getEndAddress())
                        break;
                    processCounter--;
                    this.segmentOrHoles.add(new SegmentOrHole(processCounter, "" + processCounter,
                            this.totalMemorySize - this.segmentOrHoles.get(i+1).getEndAddress()));
                ...
                processCounter--;
                this.segmentOrHoles.add(new SegmentOrHole(processCounter, "" + processCounter,
                        this.totalMemorySize - this.segmentOrHoles.get(i).getEndAddress()));
                this.segmentOrHoles.get(this.segmentOrHoles.size()-1).setSegmentStartingAddress(this.segmentOrHoles.get(this.segmentOrHoles.size()-2).getEndAddress());
                break;
